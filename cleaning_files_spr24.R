...
directory_path <- "TrackmanData/Spring24/Games"
...
for (TM_file in TM_files) {
  TM_file_path <-  paste0("TrackmanData/Spring24/Games/",TM_file)
  TM_data <- read.csv(TM_file_path)
  for(PP_file in PP_files)
  {
    PP_file_path <-  paste0("TrackmanData/Spring24/Games/",PP_file)
